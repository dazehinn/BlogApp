...
RSpec.describe 'User Index', type: :system do
  ...
  let!(:first_user) { User.create(name: 'Nshanji', photo: 'https://cdn2.iconfinder.com/data/icons/random-outline-3/48/random_14-512.png', posts_counter: 3) }
  let!(:second_user) { User.create(name: 'Hilary', photo: 'https://cdn2.iconfinder.com/data/icons/random-outline-3/48/random_14-512.png', posts_counter: 5) }
  let!(:third_user) { User.create(name: 'Ndzi', photo: 'https://cdn2.iconfinder.com/data/icons/random-outline-3/48/random_14-512.png', posts_counter: 2) }
